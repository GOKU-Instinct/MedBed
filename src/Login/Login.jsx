...
function Login() {
  ...
  function sendData() {
    axios.post("http://localhost:5400/login", newHospital).then((response) => {
      if (
        response.data === "Incorrect Username or Password. Please try again." ||
        response.data ===
          "This Hospital is not registered. Please register to proceed."
      ) {
