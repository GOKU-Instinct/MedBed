        ...
        <div className="container">
          <div className="row justify-content-center text-center">
            ...
            <div className="aboutus">
              ...
              <br />
              We all know the situations arised in the initial phase. The beds
              and ventilators in hospitals were started getting booked at a
              rapid rate and many patient havent got treatment due to flooded
              hospitals or we can say that as the patient were unaware of
              exactly which hospital(s) have some vacant beds.
              <br />
